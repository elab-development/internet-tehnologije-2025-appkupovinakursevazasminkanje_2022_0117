      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div>
            <div className="flex justify-between items-center mb-1 px-1">
              ...
              <a href="/zaboravljena" className="text-xs font-bold hover:underline" style={{ color: "#CEAB93" }}>
                Zaboravili ste?
              </a>
            </div>
        ...
        <div className="mt-8 text-center text-sm border-t border-[#E3CAA5]/30 pt-6">
          <p style={{ color: "#CEAB93" }}>
            Nemate nalog?{" "}
            <a href="/registracija" className="font-black underline decoration-2 underline-offset-4" style={{ color: "#AD8B73" }}>
              Kreirajte ga
            </a>
          </p>
        </div>
